...
var FlatPagination = function (_React$PureComponent) {
  ...
  _createClass(FlatPagination, [{
    ...
    value: function renderEndButton(targetPage, label, key) {
      return _react2.default.createElement(_Button2.default, _extends({}, _react2.default.isValidElement(label) ? { icon: _react2.default.cloneElement(label, { style: _extends({}, styles.labelStyle, label.props.style) }) } : { label: label, labelStyle: _extends({}, styles.labelStyle, this.props.otherPageLabelStyle) }, {
...
FlatPagination.propTypes = {
  ...
  currentPageHoverColor: _Button2.default.propTypes.hoverColor,
  currentPageLabelStyle: _Button2.default.propTypes.labelStyle,
  currentPageStyle: _Button2.default.propTypes.style,
  disabled: _Button2.default.propTypes.disabled,
  disableTouchRipple: _Button2.default.propTypes.disableTouchRipple,
  hoverColor: _Button2.default.propTypes.hoverColor,
  nextPageLabel: _propTypes2.default.node,
  onClick: _Button2.default.propTypes.onClick,
  otherPageLabelStyle: _Button2.default.propTypes.labelStyle,
  otherPageStyle: _Button2.default.propTypes.style,
  previousPageLabel: _propTypes2.default.node,
  rippleColor: _Button2.default.propTypes.rippleColor,
